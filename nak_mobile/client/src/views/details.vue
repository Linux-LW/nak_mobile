<template>
  <div class="details">
    ...
    <div class="nav" :class="{show:tap}">
          <ul>
            <li><router-link to="/">
            <img src="../assets/detailIcons/home.png"> <br>
            首页
            </router-link></li>
            <li>
              <router-link to="/class">
                <img src="../assets/detailIcons/menu.png"> <br>
                分类
              </router-link>
            </li>
            <li>
              <router-link to="/search">
                <img src="../assets/detailIcons/search.png"> <br>
                搜索
              </router-link>
            </li>
            <li @click="toCart">
                <img src="../assets/detailIcons/cart.png"> <br>
                购物车
            </li>
            <li @click="toMine">
                <img src="../assets/detailIcons/self.png"> <br>
                个人中心
            </li>
          </ul>
        </div>
    ...
    <div class="addCount">
        ...
        <!-- 商品咨询的div -->
          <div class="hide" :class="{appear:intro3}">
            <textarea id="" style="width:100%" cols="40" rows="10" placeholder="您有任何问题，可以通过这里向卖家咨询" class="desc"></textarea>
            <button style="width:100%; height:40px; color:white; font-size:18px; background-color:#26a2ff;margin-bottom:50px;margin-top:10px;border-radius:5px">提交咨询</button>
          </div>
