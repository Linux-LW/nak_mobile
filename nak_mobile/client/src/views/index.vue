  ...
  <div class="index">
    ...
    <div class="navbar">
      <ul>
        ...
        <li @click="toOrder"><img src="../assets/icons/order.png" alt="">
          <p>我的订单</p></li>
        <li @click="toMine"><img src="../assets/icons/self.png" alt="">
          <p>会员中心</p></li>
        <li @click="toCart"><img src="../assets/icons/cart.png" alt="">
          <p>购物车</p></li>
      </ul>
    </div>
    <!-- 头部导航结束 -->
    <!-- 内容区域开始 -->
    <div class="panl" infinite-scroll-distance="30" v-infinite-scroll="loop" infinite-scroll-disable="stop" infinite-scroll-immediate-check="true">
    <mt-tab-container>
